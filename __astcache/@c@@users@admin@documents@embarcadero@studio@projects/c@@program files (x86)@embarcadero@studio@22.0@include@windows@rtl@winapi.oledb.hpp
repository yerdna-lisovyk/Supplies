...
// (DO NOT EDIT: machine generated header) 'Winapi.OleDB.pas' rev: 35.00 (Windows)
...
{
	virtual HRESULT __stdcall AddRefRows(NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __stdcall GetData(NativeUInt HROW, NativeUInt HACCESSOR, void * pData) = 0 ;
	virtual HRESULT __stdcall GetNextRows(NativeUInt hReserved, NativeInt lRowsOffset, NativeInt cRows, /* out */ NativeUInt &pcRowsObtained, PULONG_PTRArray &prghRows) = 0 ;
	virtual HRESULT __stdcall ReleaseRows(NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgRowOptions, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
...
{
	virtual HRESULT __safecall AddRefRows(NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __safecall GetData(NativeUInt HROW, NativeUInt HACCESSOR, void * pData) = 0 ;
	virtual HRESULT __safecall GetNextRows(NativeUInt hReserved, NativeInt lRowsOffset, NativeInt cRows, /* out */ NativeUInt &pcRowsObtained, PULONG_PTRArray &prghRows) = 0 ;
	virtual HRESULT __safecall ReleaseRows(NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgRowOptions, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
...
__interface  INTERFACE_UUID("{0C733A7D-2A1C-11CE-ADE5-00AA0044773D}") IRowsetLocate  : public IRowset 
{
	...
	virtual HRESULT __stdcall GetRowsByBookmark(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rgcbBookmarks, PPByteArray rgpBookmarks, PULONG_PTRArray rghRows, PUintArray rgRowStatus) = 0 ;
...
__interface  INTERFACE_UUID("{0C733A7D-2A1C-11CE-ADE5-00AA0044773D}") IRowsetLocateSC  : public IRowsetSC 
{
	...
	virtual HRESULT __safecall GetRowsByBookmark(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rgcbBookmarks, PPByteArray rgpBookmarks, PULONG_PTRArray rghRows, PUintArray rgRowStatus) = 0 ;
...
__interface  INTERFACE_UUID("{0C733A84-2A1C-11CE-ADE5-00AA0044773D}") IRowsetResynch  : public System::IInterface 
{
	...
	virtual HRESULT __stdcall ResynchRows(NativeUInt cRows, PULONG_PTRArray rghRows, PULONG_PTR pcRowsResynched, /* out */ PHROW &prghRowsResynched, PPDBROWSTATUS prgRowStatus) = 0 ;
};
...
__interface  INTERFACE_UUID("{0C733A84-2A1C-11CE-ADE5-00AA0044773D}") IRowsetResynchSC  : public System::IInterface 
{
	...
	virtual HRESULT __safecall ResynchRows(NativeUInt cRows, PULONG_PTRArray rghRows, PULONG_PTR pcRowsResynched, /* out */ PHROW &prghRowsResynched, PPDBROWSTATUS prgRowStatus) = 0 ;
};
...
{
	virtual HRESULT __stdcall DeleteRows(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgRowStatus) = 0 ;
...
{
	virtual HRESULT __safecall DeleteRows(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgRowStatus) = 0 ;
...
__interface  INTERFACE_UUID("{0C733A6D-2A1C-11CE-ADE5-00AA0044773D}") IRowsetUpdate  : public IRowsetChange 
{
	...
	virtual HRESULT __stdcall GetRowStatus(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgPendingStatus) = 0 ;
	virtual HRESULT __stdcall Undo(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PULONG_PTR pcRowsUndone, PPHROW prgRowsUndone, PPDBROWSTATUS prgRowStatus) = 0 ;
	virtual HRESULT __stdcall Update(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PULONG_PTR pcRows, PPHROW prgRows, PPDBROWSTATUS prgRowStatus) = 0 ;
};
...
__interface  INTERFACE_UUID("{0C733A6D-2A1C-11CE-ADE5-00AA0044773D}") IRowsetUpdateSC  : public IRowsetChangeSC 
{
	...
	virtual HRESULT __safecall GetRowStatus(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PUintArray rgPendingStatus) = 0 ;
	virtual HRESULT __safecall Undo(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PULONG_PTR pcRowsUndone, PPHROW prgRowsUndone, PPDBROWSTATUS prgRowStatus) = 0 ;
	virtual HRESULT __safecall Update(NativeUInt hReserved, NativeUInt cRows, PULONG_PTRArray rghRows, PULONG_PTR pcRows, PPHROW prgRows, PPDBROWSTATUS prgRowStatus) = 0 ;
};
...
{
	virtual HRESULT __stdcall RefreshVisibleData(NativeUInt HCHAPTER, NativeUInt cRows, PULONG_PTRArray rghRows, System::LongBool fOverWrite, PULONG_PTR pcRowsRefreshed, /* out */ PHROW &prghRowsRefreshed, PPDBROWSTATUS prgRowStatus) = 0 ;
...
{
	virtual HRESULT __safecall RefreshVisibleData(NativeUInt HCHAPTER, NativeUInt cRows, PULONG_PTRArray rghRows, System::LongBool fOverWrite, PULONG_PTR pcRowsRefreshed, /* out */ PHROW &prghRowsRefreshed, PPDBROWSTATUS prgRowStatus) = 0 ;

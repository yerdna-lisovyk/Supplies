...
namespace System
{
  ...
  {
    System::Internal::Strhlpr::UnicodeFromWide(*this, STR_CAST_(WideString&, src));
  }
#endif
  ...
  UnicodeString& UnicodeString::operator+=(const UnicodeString& src)
  {
    System::Internal::Strhlpr::UnicodeAppend(*this, STR_CAST_(UnicodeString&, src));
    return *this;
  }
  ...
  UnicodeString UnicodeString::operator+(const UnicodeString& rhs) const
  {
    ...
    System::Internal::Strhlpr::UnicodeAppend(tmp, STR_CAST_(UnicodeString&, rhs));
    return tmp;
  }

  bool UnicodeString::operator==(const UnicodeString& other) const
  {
    return System::Internal::Strhlpr::UnicodeEqual(STR_CAST_(UnicodeString&, *this), STR_CAST_(UnicodeString&, other));
  }
  ...
  bool UnicodeString::operator<(const UnicodeString& other) const
  {
    return System::Internal::Strhlpr::UnicodeLess(STR_CAST_(UnicodeString&, *this), STR_CAST_(UnicodeString&, other));
  }

  bool UnicodeString::operator>(const UnicodeString& other) const
  {
    return System::Internal::Strhlpr::UnicodeGreater(STR_CAST_(UnicodeString&, *this), STR_CAST_(UnicodeString&, other));
  }
...
#undef sprintf
  ...
  {
    System::Internal::Strhlpr::UnicodeInsert(*this, STR_CAST_(UnicodeString&, source), index);
    return *this;
  }
  ...
  {
    return System::Internal::Strhlpr::UnicodePos(STR_CAST_(UnicodeString&, *this), STR_CAST_(UnicodeString&, subStr));
  }
  ...
  UnicodeString operator+(const char* lhs, const UnicodeString& rhs)
  {
    ...
    return System::Internal::Strhlpr::UnicodeCat(tmp, STR_CAST_(UnicodeString&, rhs));
  }
  ...
  {
    // This creates an intermediate AnsiString. Would it be better to cast ch to WideChar and
    // use the StringOfChar overload that creates a UnicodeString?
    str = System::StringOfChar(ch, 1);
  }
  ...
  {
    // Is there a platform where WideChar is not UTF-16?
